...
class qpsk_loopback_jupiter(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "qpsk_loopback_jupiter", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("qpsk_loopback_jupiter")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "qpsk_loopback_jupiter")
        ...
        self.lo_offset = lo_offset = int(00)
        ...
        self.top_grid_layout.addWidget(self._hardwaregain_rx0_win, 5, 1, 1, 1)
        for r in range(5, 6):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.blocks_phase_shift_0_0 = blocks.phase_shift(phase_shift_before_costas_loop, True)
        ...
        self.connect((self.blocks_phase_shift_0_0, 0), (self.digital_constellation_receiver_cb_0, 0))
        ...
        self.connect((self.digital_constellation_receiver_cb_0, 3), (self.blocks_null_sink_0_0_0, 0))
        ...
        self.connect((self.digital_symbol_sync_xx_0, 0), (self.blocks_phase_shift_0_0, 0))
    ...
    def set_phase_shift_before_costas_loop(self, phase_shift_before_costas_loop):
        ...
        self.blocks_phase_shift_0_0.set_shift(self.phase_shift_before_costas_loop)
...
def main(top_block_cls=qpsk_loopback_jupiter, options=None):
