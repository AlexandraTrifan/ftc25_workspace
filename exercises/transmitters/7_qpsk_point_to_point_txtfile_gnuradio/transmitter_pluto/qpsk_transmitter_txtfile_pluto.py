...
# Title: qpsk_transmitter_txtfile_pluto
...
class qpsk_transmitter_txtfile_pluto(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "qpsk_transmitter_txtfile_pluto", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("qpsk_transmitter_txtfile_pluto")
        ...
        self.settings = Qt.QSettings("GNU Radio", "qpsk_transmitter_txtfile_pluto")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:/Users/VBeleca/OneDrive - Analog Devices, Inc/Desktop/transmitters_ftc2025_v1/7_qpsk_point_to_point_txtfile_gnuradio/transmitter_pluto/padded.txt', True, 0, 0)
...
def main(top_block_cls=qpsk_transmitter_txtfile_pluto, options=None):
